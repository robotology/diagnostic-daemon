...
void ComponentFile::acceptMsg(std::string& msg,unsigned int,udp::endpoint senderEndPoint,Severity severity)
{
    fstream_<< msg<<std::endl;    
}

void ComponentFile::acceptMsg(std::array<uint8_t,maxMsgLenght_>& msg,unsigned int size,udp::endpoint,Severity severity)
{
