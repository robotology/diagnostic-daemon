...
TEST(Parser1, test1) {
    ...
    std::stringstream ss;
     ss<<"<udpheader name='udpheader'> <param name='startcode' size='1' value='120' longdescription='start code byte1' show='true'/>"
        ...
        "<param name='datasize' size='2' uom='byte' value='8' encoding='littleendian' longdescription='datasize' show='true'/>"
        "<param name='id' size='4' value='65541' uom='byte' longdescription='id' show='true'/>"
        "<param name='data' conditionorvalue='2 3 4 5' conditionname='ropc' conditionallevelup='0' conditionallength='datasize' size='8' value='123' longdescription='id' show='true'/>"
